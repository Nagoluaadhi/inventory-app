  ...
  return (
    <div>
      ...
      <div className="flex gap-4 mb-4">
        <button onClick={() => exportToExcel(data, 'report')} className="bg-green-500 text-white px-4 py-2 rounded">Export Excel</button>
      ...
      <div id="report-table">
        <table className="w-full border text-sm">
          ...
          <tbody>
            {data.length === 0 ? (
              <tr>
                <td className="border px-2 text-center" colSpan="9">No records found</td>
              </tr>
            ) : (
              data.map((row, i) => (
                <tr key={row.id}>
